...
public class OrderTask implements Task {
    ...
    public void execute(Robot robot, EquipmentManager manager) throws InterruptedException { 
    	System.out.printf("[%s] Executing %s (%s)%n", robot.getId(), this.orderId, this.productID);
        ...
        if (assignedStation == null) {
             System.out.printf("[%s] Interrupted while waiting for Packing LoadingStation for Order %s. Aborting.%n", robot.getId(), this.productID);
        ...
        // TODO: 7. Reduce the quantity of ordered product
